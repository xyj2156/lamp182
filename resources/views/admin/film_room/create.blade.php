            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl"><a href="{{url('admin/filmroom')}}">影厅管理 </a> > 添加影厅</div>
                    </div>
                    <div class="widget-body am-fr">
                        <form class="am-form tpl-form-line-form" method="post" action="{{url('admin/filmroom')}}">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="filmroom-name" name="name" placeholder="请输入影厅号/名字" value="{{old('')}}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="password" class="am-u-sm-3 am-form-label">座位信息 <span class="tpl-form-line-small-title">Seat</span></label>
                                <div class="am-u-sm-9">
                                    <a href="{{url('admin/filmroom/seat')}}">点我修改座位信息</a>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="age" class="am-u-sm-3 am-form-label">播放电影 <span class="tpl-form-line-small-title">Film</span></label>
                                <div class="am-u-sm-9">
                                    <select data-am-selected="{searchBox: 99}" style="display: none;" name="sex">
                                        <option value="0">==请在下面输入框筛选==</option>
                                        @foreach($film as $v)<option value="{{$v -> id}}">{{$v -> name}}</option>@endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="am-form-group">
