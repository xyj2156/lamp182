            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body am-fr">
                        <form class="am-form tpl-form-line-form" method="post" action="{{url('admin/filmrooms')}}">
                            {{csrf_field()}}
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="filmroom-name" required name="name" placeholder="请输入影厅号/名字" value="{{old('name')}}">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">座位信息 <span class="tpl-form-line-small-title">Seat</span></label>
                                <div class="am-u-sm-9" id="seat">
                                    <input type="number" min="1" value="{{old('row') ? old('row') : '10'}}" name="row">排 <input min="1" type="number" value="{{old('col') ? old('col') : '10'}}" name="col">列 黄色代表有座位,白色代表没有
                                    <div id="seats"></div>
                                </div>
                            </div>
...
//            初始生成表格
            create($('#seat>input').eq(0).val(), $('#seat>input').eq(1).val());
//            初始如果后台传过来座位信息 解析
            show('{{old('seat')}}');
