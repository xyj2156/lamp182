    ...
    <div class="container-fluid am-cf">
        <div class="row">
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 评论管理 <small>江洋八子</small></div>
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-fl">电影: {{$filmName}}评论</div>
                </div>
                ...
                $.post(
                    ...
                    function (msg){
                        ...
                        if (msg.status){
                            ...
                            icon = 6;
                            setTimeout(function(){
                                location.href = '{{url("admin/review")}}/{{$fid}}';
                            },2000);
                        }
