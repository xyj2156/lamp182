...
class WebConfigController extends Controller
{
    ...
    {
        $data = Webconfig::select('title','email', 'logo', 'keywords', 'description','copyright', 'icp', 'tel', 'count') -> find(1);
        $title = '网站配置修改';
    ...
    public function postIndex(Request $req)
    {
        ...
        if( $config -> update($req -> only(['title', 'email', 'logo', 'keywords', 'description', 'copyright', 'icp', 'tel', 'count']) )) {
//            向配置文件中更新配置项
